...
Как правило, для старта и передачи данных требуется **не менее 5 минут.**

# Описание

Подробное описание API доступно по адресу: http://127.0.0.1/api/openapi#/ (необходим запущенный сервис)
